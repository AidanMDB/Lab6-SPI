...
void setup_dma(void) {
    ...
    DMA1_Channel5 -> CPAR = &(SPI2 -> DR); // this is what changed
...
void init_tim15(void) {
    ...
    TIM15 -> PSC = 4800 - 1;          // 48000000 / 4800 / 1000 = 1kHz
    TIM15 -> ARR = 1000 - 1;
...
void init_spi2(void) {
    ...
    SPI2 -> CR1 &= ~SPI_CR1_SPE;                     // ensures SPI is clear
    SPI2 -> CR1 |=  SPI_CR1_MSTR | SPI_CR1_BR;       // enables master and max br
    SPI2 -> CR2 =   SPI_CR2_DS_3 | SPI_CR2_DS_2 | SPI_CR2_DS_1 | SPI_CR2_DS_0; // enables DS to 1111 for 16-bit
    SPI2 -> CR2 |=  SPI_CR2_SSOE | SPI_CR2_NSSP;     // enables SS Output and  NSSP
    SPI2 -> CR2 |=  SPI_CR2_TXDMAEN;                 // enables TXDMAEN
    SPI2 -> CR1 |=  SPI_CR1_SPE;                     // enables SPI channel;
}
...
void init_spi1() {
    ...
    SPI1 -> CR1 &= ~SPI_CR1_SPE;                     // ensures SPI is clear
    SPI1 -> CR1 |=  SPI_CR1_MSTR | SPI_CR1_BR;       // enables master and max br
    SPI1 -> CR2 =   SPI_CR2_DS_3 | SPI_CR2_DS_0; // enables DS to 1111 for 16-bit
    SPI1 -> CR2 |=  SPI_CR2_SSOE | SPI_CR2_NSSP;     // enables SS Output and  NSSP
    SPI1 -> CR2 |=  SPI_CR2_TXDMAEN;                 // enables TXDMAEN
    SPI1 -> CR1 |=  SPI_CR1_SPE;                     // enables SPI channel;
    // PA5  SPI1_SCK
    // PA6  SPI1_MISO
    // PA7  SPI1_MOSI
    // PA15 SPI1_NSS
...
void spi1_setup_dma(void) {
    ...
    DMA1_Channel3 -> CMAR = (uint32_t) display; //wrong
    DMA1_Channel3 -> CPAR = &(SPI1 -> DR); // this is what changed
    DMA1_Channel3 -> CNDTR = 34; //wrong
